...
SRCS_MPLAYER-$(ZPUINO)       += libvo/vo_zpuino.c
SRCS_MPLAYER-$(ZPUINO)       += libvo/zpuino/sysdeps_linux.c
SRCS_MPLAYER-$(ZPUINO)       += libvo/zpuino/hdlc.c
SRCS_MPLAYER-$(ZPUINO)       += libvo/zpuino/crc16.c
